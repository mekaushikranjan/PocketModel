 ...
 * NOTE: Pal feature has been removed - this function is deprecated
 * @param palId The ID of the pal to export
 */
export const exportPal = async (palId: string): Promise<void> => {
  console.warn('Pal export is no longer supported');
};
...
// Pal export functions removed - pal feature deleted
          ...
          [
            {
              ...
              onPress: async () => {
                ...
                try {
                  const options = {
                    title: `Share ${filename}`,
                    message: 'ExamPrepAI Chat Export',
                    url: `file://${savePath}`,
                    type: 'application/json',
                    failOnCancel: false,
                  };
