...
const en = {
  ...
  about: {
    ...
    description:
      'A completely offline, local AI model runner for your device. Interact with curated or custom models without sending data to external servers.',
    supportProject: 'Support the Project',
    supportProjectDescription:
      'If you enjoy using PocketModel, please consider supporting the project by:',
  ...
  feedback: {
    title: 'Send Feedback',
    description:
      'Your voice matters! Tell us how PocketModel is helping you and what we can do to make it even more useful.',
    shareThoughtsButton: 'Sharing your thoughts',
    useCase: {
      label: 'What are you using PocketModel for?',
    ...
    usageFrequency: {
      label: 'How often do you use PocketModel? (Optional)',
      options: {
        daily: 'Daily',
        weekly: 'Weekly',
        monthly: 'Monthly',
  ...
  components: {
    ...
    chatEmptyPlaceholder: {
      ...
      noModelsDescription:
        'Download a model to start chatting with PocketModel',
  ...
  camera: {
    ...
    permissionMessage: 'ExamPrepAI needs camera access to analyze images',
  ...
  video: {
    permissionTitle: 'Camera Permission Required',
    permissionMessage: 'ExamPrepAI needs camera access for video analysis',
    requestingPermission: 'Requesting camera permission...',
    noDevice: 'No camera device found',
    errorTitle: 'Camera Error',
...
export const l10n = {
  ...
  ja: {
    ...
    about: {
      ...
      supportProjectDescription:
        'ExamPrepAIをご利用いただき楽しんでいただけているなら、以下の方法でプロジェクトを応援いただけると幸いです：',
    ...
    feedback: {
      title: 'フィードバックを送信',
      description:
        'ご意見をお聞かせください！ExamPrepAIの使い心地やより便利にするためのアイデアをお寄せください',
      shareThoughtsButton: 'ご意見を共有する',
      useCase: {
        label: 'ExamPrepAIをどのように使っていますか？',
    ...
    components: {
      ...
      chatEmptyPlaceholder: {
        ...
        noModelsDescription:
          'ExamPrepAIとチャットを始めるにはモデルをダウンロードしてください',
    ...
    camera: {
      ...
      permissionMessage:
        'ExamPrepAIが画像を分析するにはカメラへのアクセスが必要です',
    ...
    video: {
      permissionTitle: 'カメラ許可が必要',
      permissionMessage:
        'ExamPrepAIが動画を分析するにはカメラへのアクセスが必要です',
      requestingPermission: 'カメラの許可をリクエスト中...',
      noDevice: 'カメラデバイスが見つかりません',
      errorTitle: 'カメラエラー',
  ...
  zh: {
    ...
    about: {
      ...
      supportProject: '支持项目',
      supportProjectDescription:
        '如果你喜欢使用ExamPrepAI，请考虑通过以下方式支持项目：',
    ...
    feedback: {
      title: '发送反馈',
      description:
        '你的声音很重要！告诉我们ExamPrepAI如何帮助你以及我们可以做什么来使其更有用',
      shareThoughtsButton: '分享你的想法',
      useCase: {
        label: '你如何使用ExamPrepAI？',
    ...
    components: {
      ...
      chatEmptyPlaceholder: {
        ...
        noModelsDescription: '需要下载一个模型，才能与ExamPrepAI开始聊天',
        noModelsButton: '下载模型',
        activateModelTitle: '在你和ExamPrepAI开始聊天前，请先激活模型~',
    ...
    camera: {
      ...
      permissionMessage: 'ExamPrepAI需要访问摄像头来分析图像',
    ...
    video: {
      permissionTitle: '需要摄像头权限',
      permissionMessage: 'ExamPrepAI需要访问摄像头来分析视频',
      requestingPermission: '请求摄像头权限...',
      noDevice: '未找到摄像头设备',
      errorTitle: '摄像头错误',
